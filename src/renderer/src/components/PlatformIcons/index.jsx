...
const PlatformIcons = ({ handlePlatformClick }) => {
  const platforms = [
    { Component: FaYoutube, url: "https://www.youtube.com", color: "#FF0000", alt: "YouTube", domain: "www.youtube.com" },
    { Component: FaTiktok, url: "https://www.tiktok.com", color: "#000000", alt: "TikTok", domain: "www.tiktok.com" },
    { Component: FaInstagram, url: "https://www.instagram.com/reels", color: "#E4405F", alt: "Instagram", domain: "www.instagram.com" },
    { Component: FaSnapchat, url: "https://www.snapchat.com/spotlight", color: "#FFFC00", alt: "Snapchat", domain: "snapchat.com" },
    { Component: FaTwitter, url: "https://twitter.com", color: "#1DA1F2", alt: "Twitter", domain: "www.twitter.com" },
    { Component: FaFacebook, url: "https://www.facebook.com/watch", color: "#1877F2", alt: "Facebook", domain: "www.facebook.com" },
    ...
    { Component: FaLinkedin, url: "https://www.linkedin.com", color: "#0077B5", alt: "LinkedIn", domain: "www.linkedin.com" },
  ];
  ...
  return (
    <section className="download-hub">
      ...
      <div className="platform-grid">
        {platforms.map(({ Component, url, color, alt, domain }, index) => (
          <div
            key={index}
